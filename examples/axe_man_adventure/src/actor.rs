...
impl std::fmt::Display for ActorDirection {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ActorDirection::North => write!(f, "North"),
            ActorDirection::East => write!(f, "Profile"),
            ActorDirection::South => write!(f, "South"),
            ActorDirection::West => write!(f, "Profile"),
        }
    }
}
...
#[derive(Debug, Event)]
pub(crate) struct ActorAttemptMoveEvent;
