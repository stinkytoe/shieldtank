...
pub struct LayerDefinition {
    pub handle: Handle<LdtkLayerDefinition>,
}

impl LayerDefinition {
    pub(crate) fn new(handle: Handle<LdtkLayerDefinition>) -> Self {
        Self { handle }
    }
}

impl AsAssetId for LayerDefinition {
    type Asset = LdtkLayerDefinition;
...
impl Plugin for LayerDefinitionPlugin {
    fn build(&self, app: &mut bevy_app::App) {
        app.register_type::<LayerDefinition>();
    }
}
